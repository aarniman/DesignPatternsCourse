...
public class Gui extends Application {
    ...
    public void start(Stage stage) {
        ...
        historyButton.setOnAction(event -> {
            History historyWindow = new History(controller);
            historyWindow.updateHistory(controller.getHistory());
            historyWindow.show();
        });

        // Create a VBox that contains the HBox, CheckBox, label, and history button
